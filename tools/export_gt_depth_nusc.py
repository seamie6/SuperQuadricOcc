''''
File courtesy of GaussianOcc 
https://github.com/GANWANSHUI/GaussianOcc/blob/master/tools/export_gt_depth_nusc.py
'''
...
class DepthGenerator(object):
    def __init__(self, split='train'):
        ...
        with open(f'data/bevdetv2-nuscenes_infos_{split}.pkl', 'rb') as f:
            self.data = pickle.load(f)['infos']

        self.save_path = 'data/gt_depth'
